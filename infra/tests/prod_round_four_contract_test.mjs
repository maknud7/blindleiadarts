...
const metadataCompletion = fs.readFileSync('infra/sql/atlas_complete_round_four_metadata_test.php', 'utf8');
...
assert.match(metadataCompletion, /points_distribution/);
assert.match(metadataCompletion, /source_scores/);
assert.match(metadataCompletion, /'5' => 1/);
