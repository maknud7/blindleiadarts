(() => {
  ...
  // WebSocket remains the primary realtime transport. If it is unavailable or
  // disconnects, app.js must fall back to the canonical Node-backed kiosk state
  // endpoint instead of opening the legacy PHP SSE /live route.
  try {
