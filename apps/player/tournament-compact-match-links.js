...
.tdx-group-match-row:first-child{border-top:0}.tdx-group-match-row:active{background:#f4f8fc}.tdx-group-match-row>.tdx-player-link:last-of-type{text-align:right!important;justify-self:end}.tdx-group-match-row>strong{font-size:13px}.tdx-group-match-row>small{grid-column:1/-1;color:#7b8da0;font-size:10px;margin-top:-2px}
...
document.addEventListener("click",event=>{
  ...
  if(player){ event.preventDefault(); event.stopPropagation(); event.stopImmediatePropagation(); openPlayerProfileFromMatch(player); return; }
