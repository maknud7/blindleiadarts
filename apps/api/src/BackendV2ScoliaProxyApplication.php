 ...
 *
 * The paired-kiosk surface also owns the canonical kiosk scoring/pairing front
 * door in TEST: state, start-match, visit, undo and unpair stay in backend-v2
 * once selected. PROD remains on PHP while scolia_routing_mode is php.
 *
