...
.bd-shared-match-board{border:1px solid #d9e3ee;border-radius:16px;overflow:hidden}.bd-shared-match-names,.bd-shared-match-row{display:grid;grid-template-columns:minmax(0,1fr) 118px minmax(0,1fr);gap:8px;align-items:center;text-align:center}.bd-shared-match-names{padding:13px 12px;background:#f6f9fd}.bd-shared-match-names strong:first-child,.bd-shared-match-row strong:first-child{text-align:left}.bd-shared-match-names strong:last-child,.bd-shared-match-row strong:last-child{text-align:right}.bd-shared-match-row{padding:11px 12px;border-top:1px solid #e7edf2}.bd-shared-match-row span{font-size:.75rem;color:#71849a;font-weight:800}.bd-shared-match-row.primary{background:#f4f8ff}.bd-shared-match-row.primary strong{font-size:1.08rem;color:#123f74}.bd-shared-match-row.checkout{background:#f8fbff}.bd-shared-match-row.checkout span{color:#2f6fed}
