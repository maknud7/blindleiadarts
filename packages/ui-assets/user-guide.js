    ...
    topics: [
      {
        id: "normal-board",
        group: "Utstyr",
        title: "Legg til en vanlig skive",
        summary: "Opprett en dartskive med manuell scoring. Du trenger ikke nettbrett eller Scolia for å opprette selve skiva.",
        steps: [
          "Åpne Klubbadmin → Utstyr.",
          "Finn området Skiver og skjemaet Opprett skive.",
          "Skriv inn skivenummeret, for eksempel 1.",
          "Gi skiva et navn hvis du ønsker det. Hvis du lar navnet stå tomt, kan skivenummeret brukes som hovedidentifikasjon.",
          "Velg Manuell under Scoring.",
          "La Scolia-feltene være tomme. De er ikke relevante for en vanlig skive.",
          "Trykk Opprett skive.",
          "Kontroller at skiva nå ligger i listen Skiver. Skiva er opprettet og kan brukes som fast enhet i lokalet.",
        ],
        note: "Skiva og nettbrettet er to forskjellige ting. Skiva er den permanente enheten; et nettbrett kan pares, byttes eller flyttes uten at skiva må opprettes på nytt.",
      },
      {
        id: "pair-tablet",
        group: "Utstyr",
        title: "Koble et nettbrett til en skive",
        summary: "Par terminalen til en skive som allerede finnes.",
        steps: [
          "Åpne kiosk/terminal-visningen på nettbrettet.",
          "Noter pairingkoden som vises på nettbrettet.",
          "Gå til Klubbadmin → Utstyr på admin-enheten.",
          "Finn Koble nettbrett til en skive.",
          "Skriv inn pairingkoden.",
          "Velg skiva nettbrettet fysisk står ved.",
          "Trykk Koble nettbrett.",
          "Kontroller på nettbrettet at riktig skive er valgt før en kamp startes.",
        ],
        note: "Hvis et nettbrett erstattes, behold skiva og par det nye nettbrettet til samme skive.",
      },
      {
        id: "scolia",
        group: "Utstyr",
        title: "Sett opp Scolia-scoring",
        summary: "Scolia-oppsettet ligger sammen med skiver og annet klubbutstyr.",
        steps: [
          "Åpne Klubbadmin → Utstyr.",
