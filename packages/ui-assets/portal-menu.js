...
ensureStylesheet("./unified-portal-shell.css?v=20260921-desktop-inert-01");
...
import(new URL("./unified-portal-shell.js?v=20260921-desktop-inert-01", import.meta.url).href)
